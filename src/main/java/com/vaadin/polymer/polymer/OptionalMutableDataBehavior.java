...
/**
 * <p>Legacy element behavior to add the optional ability to skip strict
 * dirty-checking for objects and arrays (always consider them to be
 * “dirty”) by setting a <code>mutable-data</code> attribute on an element instance.</p>
 ...
 * <p>While this behavior adds the ability to forgo Object/Array dirty checking,
 * the <code>mutableData</code> flag defaults to false and must be set on the instance.</p>
...
public interface OptionalMutableDataBehavior {
    ...
    /**
     * <p>Instance-level flag for configuring the dirty-checking strategy
     * for this element.  When true, Objects and Arrays will skip dirty
     * checking, otherwise strict equality checking will be used.</p>
     *
     * JavaScript Info:
